...
public class LogicalOperator01 {
	...
	public static void main(String[] args) {
        ...
        Comparison operators return boolean every time
         ...
         3 ) != is "not equal" it returns boolean
           6 != 5
        ...
        Note: Followings are "Logical Operators"
              Logical operators return boolean every time    
              
         8) && AND operator returns true if everything is true
               
         9)|| OR operator returns false if everything is false
              
         10 )  & AND operator returns true if everything is true 
		...
		System.out.println((5<2) || (5>10) || (9<15) ||(5==9));

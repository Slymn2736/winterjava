...
public class ForEachLoop01 {
	...
	public static void main(String[] args) {
		...
		//Use for loop to print all elements on the console in the 
		// same line with a space between the elements
		...
		System.out.println();
		//Use for each loop to print all elements on the console in the 
		// same line with a space between the elements
